...
## {data-background="canva_square_root.png"}
...
## {data-background="canva_correlation.png"}
...
## {data-background="canva_data_visualization.png"}
...
## {data-background="canva_string_manipulation.png"}
...
<!-- To do: -->
<!--     - change introduction -->
<!--     - explain functions before using them -->
