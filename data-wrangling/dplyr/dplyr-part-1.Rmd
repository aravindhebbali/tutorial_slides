...
knitr::include_graphics("aov_flow2.png")
```
...
For our case study, we need to select the column order value to calculate the AOV. We also need to select the device column as we are computing the AOV for different devices.
