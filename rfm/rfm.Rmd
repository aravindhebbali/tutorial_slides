...
```{r rfm_agenda, fig.align='center', echo=FALSE, out.width="100%"}
knitr::include_graphics("img/rfm_agenda.png")
```
...
recency_upper <- c(5, 4, 5, 5, 4, 3, 3, 2, 1, 1)
frequency_lower <- c(4, 3, 1, 1, 1, 2, 1, 2, 4, 1)
frequency_upper <- c(5, 4, 3, 1, 1, 3, 2, 5, 5, 1)
monetary_lower <- c(4, 3, 1, 1, 1, 2, 1, 2, 4, 1)
monetary_upper <- c(5, 4, 3, 1, 1, 3, 2, 5, 5, 1)
...
recency <- c("4 - 5", "2 - 4", "3 - 5", "4 - 5", "3 - 4", "2 - 3", "2 - 3", "< 3", "< 2", "1 - 2", "< 2")
frequency <- c("4 - 5", "3 - 4", "1 - 3", "< 2", "< 2", "2 - 3", "< 3", "2 - 5", "4 - 5", "1 - 2", "< 2")
monetary <- c("4 - 5", "3 - 4", "1 - 3", "< 2", "< 2", "2 - 3", "< 3", "2 - 5", "4 - 5", "1 - 2", "< 2")
segments <- tibble(
