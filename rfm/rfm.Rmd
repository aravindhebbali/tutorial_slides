...
```{r rfm_applications, fig.align='center', echo=FALSE}
...
```{r rfm_metrics, fig.align='center', echo=FALSE}
...
```{r rfm_segment_1, fig.align='center', echo=FALSE}
knitr::include_graphics("img/rfm_segment_1.png")
```
...
```{r rfm_segment_2, fig.align='center', echo=FALSE}
knitr::include_graphics("img/rfm_segment_2.png")
```
