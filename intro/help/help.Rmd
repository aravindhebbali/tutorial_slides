...
## {data-background="help_banner.png"}
...
knitr::include_graphics("stack-overflow.png")
```
...
knitr::include_graphics("r-bloggers.png")
```
...
```{r img3, echo=FALSE, out.width="80%", fig.align="center"}
...
[RStudio](https://www.rstudio.com/resources/) has very good resources including
cheat sheets, webinars and blogs.

<br>

```{r img4, echo=FALSE, out.width="80%", fig.align="center"}
...
```{r img5, echo=FALSE, out.width="80%", fig.align="center"}
...
```{r img6, echo=FALSE, out.width="70%", fig.align="center"}
...
```{r img7, echo=FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics("r-weekly.png")
```
...
There are several R User Groups active across the globe. You can find the list [here](https://jumpingrivers.github.io/meetingsR/r-user-groups.html). Join the
local user group to meet, discuss and learn from other R enthusiasts and experts.

```{r img8, echo=FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics("user-group.png")
```
