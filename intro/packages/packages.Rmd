...
In this module, we will learn about R packages. Packages are fundamental to R. There are approximately 11000 packages available on [CRAN](https://cran.r-project.org/) or the Comprehensive R Archive Network.
