...
- read all rows & columns from `trade` table
- read first 30 rows from `trade` table
...
- check if table `mytable` exists
- create new table using the following data
- list all tables to check if the new table has been created
- overwrite the table
- append the below data
- insert the following data
- append the below table
- remove `mytable`
...
## {data-background="dbi_section_generate_sql_query.png"}
...
- use RStudio SQL script to run the following
- create a html report for `trade` data
...
- use dplyr to tabulate some column
- use dplyr verbs to compute something
- collect data
...
- create bar plot of referrer column
- create line chart of n_pages 
