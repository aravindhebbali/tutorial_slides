...
This is the third module in the course **Data Visualization With R**. In the previous module, we learned how to add title, subtitle and axis labels. We also learned how to modify the range of the axis. In this module, we will learn how to create scatter plots and enhance them by:
...
In certain cases we might want to fit a regression line or add horizontal/vertical lines to the scatter plots. We will learn to do that in the next module, where we build line plots.