...
This is the seventh module in the series **Data Visualization With R**. In the previous module, we learnt about box and whisker plots. In this module, we will learn about histograms.
...
Before we end this module, let us add a title and axis labels to the histogram. If you do not know how to add title and axis labels, refer to this [post](https://rsquaredacademy.github.io/blog/post/data-visualization-with-r-title-and-axis-labels/).
...
In this module, we learnt how to construct and use histograms to examine the underlying distribution of a continuous variable. Specifically, we learnt how to:
...
In the next module, we will learn to add legend to plots.