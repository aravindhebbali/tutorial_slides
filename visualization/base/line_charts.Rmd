...
This is the fourth module in the course **Data Visualization With R**. In the previous module, we learnt how to build scatter plots. In this module, we will build line graphs. To be more specific we will learn to 
...
In the next module, we will learn how to build bar plots which are used to visualize a single categorical data or the relationship between two categorical variables.