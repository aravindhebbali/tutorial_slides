...
This is the ninth module in the course **Data Visualization With R**. In the previous module, we learnt how to add legend to a plot. In this module, we will learn to add text annotations.
...
In this module, we learnt how to add text annotations to a plot. Specifically, we learnt to:
...
In the next module, we will learn how to combine multiple plots into a single frame. 
