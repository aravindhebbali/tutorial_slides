...
This is the sixth module in the course **Data Visualization With R**. In the previous module, we learnt how to build bar plots. In this module, we will learn about box plots.
...
In this module, we learnt how to create box plots. Specifically, we learnt to:
...
In the next module, we will learn about histograms.