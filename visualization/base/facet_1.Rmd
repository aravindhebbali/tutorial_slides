...
```{r facet2,fig.align='center',fig.height=7,fig.width=7}
# store the current parameter settings in init
init <- par(no.readonly=TRUE)
...
```{r facet3,fig.align='center',fig.height=7,fig.width=7}
# store the current parameter settings in init
init <- par(no.readonly=TRUE)
...
```{r facet4,fig.align='center',fig.height=7,fig.width=7}
# store the current parameter settings in init
init <- par(no.readonly=TRUE)
...
```{r facet5,fig.align='center',fig.height=7,fig.width=7}
# store the current parameter settings in init
init <- par(no.readonly=TRUE)
...
```{r facet6,fig.align='center',fig.height=7,fig.width=7}
# store the current parameter settings in init
init <- par(no.readonly=TRUE)
...
```{r facet7,fig.align='center',fig.height=7,fig.width=7}
# store the current parameter settings in init
init <- par(no.readonly=TRUE)
...
```{r facet8,fig.align='center',fig.height=7,fig.width=7}
# store the current parameter settings in init
init <- par(no.readonly=TRUE)
...
```{r facet9,fig.align='center',fig.height=7,fig.width=7}
# specify the layout
...
```{r facet11,fig.align='center',fig.height=7,fig.width=7}
# specify the matrix
...
```{r facet12,fig.align='center',fig.height=7,fig.width=7}
# specify the matrix
...
```{r facet13,fig.align='center',fig.height=7,fig.width=7}
# specify the matrix
...
```{r facet14,fig.align='center',fig.height=7,fig.width=7}
# specify the matrix
...
```{r facet15,fig.align='center',fig.height=7,fig.width=7}
# specify the matrix
...
```{r facet16,fig.align='center',fig.height=7,fig.width=7}
# specify the matrix
...
```{r facet17,fig.align='center',fig.height=7,fig.width=7}
...
```{r facet18,fig.align='center',fig.height=7,fig.width=7}
# specify the matrix
